...
import com.lilipay.wechat.utils.HttpUtils;
import com.lilipay.wechat.utils.SignUtils;
...
public class WechatGateServiceImpl implements WechatGateService {
    ...
    public Response<WechatPayUnifiedOrderGateOutput> unifiedOrder( WechatPayUnifiedOrderGateInput wechatPayUnifiedOrderGateInput ) {
        ...
        WechatPayUnifiedOrderOutputXml outputXml = JAXBUtils.toObject( result, WechatPayUnifiedOrderOutputXml.class );
        ...
        if ( Objects.equals( "SUCCESS", outputXml.getResultCode() ) ) {
            ...
            if ( Objects.equals( outputXml.getTradeType(), "JSAPI" ) ) {
                ...
                appPayRequest.setSign( SignUtils.signJsapi( JAXBUtils.toString( weixinJsapiResignDomain ), key ) );
                unifiedOrderResponse.setPrepayId( outputXml.getPrepayId() );
                unifiedOrderResponse.setAppPayRequest( appPayRequest );
            }
    ...
    public Response<WechatPayOrderQueryGateOutput> orderQuery( WechatPayOrderQueryGateInput wechatPayOrderQueryGateInput ) {
        ...
        WechatPayOrderQueryOutputXml outputXml = JAXBUtils.toObject( result, WechatPayOrderQueryOutputXml.class );
    ...
    public Response<WechatPayNoticeGateOutput> acceptNotice( WechatPayNoticeGateInput wechatPayNoticeGateInput ) {
        ...
        WechatPayOrderNoticeXml weixinPayOrderNoticeXml = JAXBUtils.toObject( noticeXml, WechatPayOrderNoticeXml.class );
    ...
    public Response<WechatCloseOrderGateOutput> closeOrder( WechatCloseOrderGateInput wechatCloseOrderGateInput ) {
        ...
        closeOrderInputXml.setSign( SignUtils.sign( JAXBUtils.toString( closeOrderInputXml ), key, CHARSET ) );
        ...
        WechatCloseOrderOutputXml closeOrderOutputXml = JAXBUtils.toObject( responseStr, WechatCloseOrderOutputXml.class );
    ...
    public Response<WechatPayRefundGateOutput> refund( WechatPayRefundGateInput wechatPayRefundGateInput ) {
        ...
        WechatPayRefundOutputXml refundOutputXml = JAXBUtils.toObject( responseStr, WechatPayRefundOutputXml.class );
    ...
    public Response<WechatPayRefundQueryGateOutput> refundQuery( WechatPayRefundQueryGateInput wechatPayRefundQueryGateInput ) {
        ...
        WechatPayRefundQueryOutputXml refundQueryOutputXml = JAXBUtils.toObject( responseStr, WechatPayRefundQueryOutputXml.class );
    ...
    public Response<WechatPayRefundNoticeGateOutput> acceptRefundNotice( WechatPayRefundNoticeGateInput wechatPayRefundNoticeGateInput ) {
        ...
        WechatPayRefundResultNoticeXml refundResultNoticeXml = JAXBUtils.toObject( noticeXml, WechatPayRefundResultNoticeXml.class );
        ...
        if ( Objects.equals( refundResultNoticeXml.getReturn_code(), "SUCCESS" ) ) {
            ...
            WechatPayRefundResultReqInfoXml refundResultReqInfoXml = JAXBUtils.toObject( reqInfoXml, WechatPayRefundResultReqInfoXml.class );
